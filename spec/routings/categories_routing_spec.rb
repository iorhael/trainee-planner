...
describe 'Categories routes path', type: :routing do
  ...
  it 'routes categories Categories#index' do
    expect(get('/categories')).to route_to(controller: 'categories', locale: I18n.default_locale, action: 'index')
  end

  it 'routes create Categories#create' do
    expect(post('/categories')).to route_to(controller: 'categories', locale: I18n.default_locale, action: 'create')
  end
